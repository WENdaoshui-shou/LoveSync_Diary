...
MAIN_PROJECT_PATH = BASE_DIR.parent / 'backend'
...
INSTALLED_APPS = [
    ...
    # 主应用的用户模型（使用完整路径）
    "backend.core",  # 添加core应用以使用主应用的用户模型
]
...
MIDDLEWARE = [
    ...
    # 自定义权限中间件
    'middleware.permissions.AdminPermissionMiddleware',
    'middleware.permissions.PublicPermissionMiddleware',
]

ROOT_URLCONF = 'sys_LoveSync.urls'
...
WSGI_APPLICATION = 'sys_LoveSync.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'lovesync_diary',  # 使用与主应用相同的数据库
        'USER': 'root',
        'PASSWORD': '1028', 
        'HOST': 'localhost', 
        'PORT': '3306',  
...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'HS256',
    'SIGNING_KEY': 'django-insecure-your-secret-key-here',
    'VERIFYING_KEY': None,
